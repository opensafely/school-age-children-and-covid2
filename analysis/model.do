...
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe" do "06_univariate_analysis.do" `dataset'
}

*MULTIVARIATE MODELS (this fits the models needed for fully adj col of Table 2)
foreach dataset of any  MAIN W2  {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe" do "07a_an_multivariable_cox_models_demogADJ.do"  `dataset'
}

foreach outcome of any  non_covid_death covid_tpp_prob covid_death covid_icu covidadmission   {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe" do "07b_an_multivariable_cox_models_FULL.do" `outcome' MAIN
}

foreach outcome of any  non_covid_death covid_tpp_prob covid_death covid_icu covidadmission   {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe" do "07b_an_multivariable_cox_models_FULL.do" `outcome' W2
}


***SENSE ANALYSES
foreach outcome of any non_covid_death covid_tpp_prob covidadmission covid_icu covid_death {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe" do "07d_an_multivariable_cox_models_FULL_Sense3.do" `outcome' MAIN
}

foreach outcome of any non_covid_death covid_tpp_prob covidadmission covid_icu covid_death {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe" do "07d_an_multivariable_cox_models_FULL_Sense4.do" `outcome' MAIN
}

winexec "C:/Program Files (x86)/Stata15/Stata-64.exe" do "07d_an_multivariable_cox_models_FULL_Sense5.do" MAIN

foreach outcome of any non_covid_death covid_tpp_prob covidadmission covid_icu covid_death {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe" do "07d_an_multivariable_cox_models_FULL_Sense3.do" `outcome'  W2
}

foreach outcome of any non_covid_death covid_tpp_prob covidadmission covid_icu covid_death {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe" do "07d_an_multivariable_cox_models_FULL_Sense4.do" `outcome'  W2
}

foreach outcome of any non_covid_death covid_tpp_prob covidadmission covid_icu covid_death {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe" do "07d_an_multivariable_cox_models_FULL_Sense6.do" `outcome'  W2
}


foreach outcome of any non_covid_death covid_tpp_prob covidadmission covid_icu covid_death {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe" do "07d_an_multivariable_cox_models_FULL_Sense5.do" `outcome' W2
}
...
*Sex
foreach outcome of any  non_covid_death covid_tpp_prob covid_death covid_icu covidadmission   {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe"  do "10_an_interaction_cox_models_sex" `outcome'	MAIN
}

*Shield
foreach outcome of any  non_covid_death covid_tpp_prob covid_death covid_icu covidadmission   {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe"  do "10_an_interaction_cox_models_shield" `outcome'	MAIN
}

*Time
foreach outcome of any  non_covid_death covid_tpp_prob covid_death covidadmission   {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe"  do "10_an_interaction_cox_models_time" `outcome'	MAIN
}

*Sex
foreach outcome of any  non_covid_death covid_tpp_prob covid_death covid_icu covidadmission   {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe"  do "10_an_interaction_cox_models_sex" `outcome'	W2
}

*Shield
foreach outcome of any  non_covid_death covid_tpp_prob covid_death covid_icu covidadmission   {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe"  do "10_an_interaction_cox_models_shield" `outcome'	W2
}

*Time
foreach outcome of any  non_covid_death covid_tpp_prob covid_death covidadmission   {
winexec "C:/Program Files (x86)/Stata15/Stata-64.exe"  do "10_an_interaction_cox_models_time" `outcome'	W2
}
