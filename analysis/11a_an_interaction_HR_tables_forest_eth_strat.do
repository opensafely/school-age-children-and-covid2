...
* Open a log file
capture log close
log using "11_an_interaction_HR_tables_forest_`outcome'_ethnicity.log", text replace
...
*CHANGE THE OUTCOME BELOW TO LAST IF BRINGING IN MORE COLS
		...
		*1) GET THE RIGHT ESTIMATES INTO MEMORY
		...
		if "`modeltype'"=="fulladj" {
				cap estimates use ./output/an_interaction_cox_models_`outcome'_kids_cat3_ethnicity_MAINFULLYADJMODEL_agespline_bmicat_noeth_ageband_`x'
