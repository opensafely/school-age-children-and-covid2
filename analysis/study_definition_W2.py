...
study = StudyDefinition(
   ...
   # STUDY POPULATION
    ...
    has_12_m_follow_up=patients.registered_with_one_practice_between(
        "2019-09-01", "2020-08-31", ### 12 months prior to 1st Feb 2020
        return_expectations={
            "incidence" : 0.95,
        }
    ),
    ...
    died_date_ons=patients.died_from_any_cause(
        ...
        include_month=True,
        include_day=True,
        return_expectations={"date": {"earliest": "2020-09-01"}, "incidence" : 0.8},
    ),
   ...
   covid_tpp_probable=patients.with_these_clinical_events(
    ...
    creatinine=patients.with_these_clinical_events(
        ...
        return_expectations={
            ...
            "date": {"earliest": "2019-02-28", "latest": "2020-08-31"},
            "incidence": 0.95,
        },
    ),
...
#EXETER ALGORITHM USING EXETER CODELISTS
    ...
    temporary_immunodeficiency=patients.with_these_clinical_events(
        combine_codelists(temp_immune_codes,
                        aplastic_codes),
        between=["2019-09-01", "2020-08-31"],  ## THIS IS RESTRICTED TO LAST YEAR
        return_last_date_in_period=True,
        include_month=True,
        return_expectations={
            "date": {"earliest": "2019-03-01", "latest": "2020-08-31"}
        },
    ),
