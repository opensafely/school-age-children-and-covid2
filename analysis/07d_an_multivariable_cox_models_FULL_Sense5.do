...
if "`outcome'"=="covid_tpp_prob" & "`dataset'"=="MAIN" {
* Open a log file
capture log close
...
if "`outcome'"=="covid_tpp_prob" & "`dataset'"=="W2" {
* Open a log file
capture log close
log using "$logdir/07d_an_multivariable_cox_models_`outcome'_Sense5_time_ints`dataset'", text replace
...
if "`outcome'"=="covidadmission"  & "`dataset'"=="MAIN" {
* Open a log file
capture log close
log using "$logdir/07d_an_multivariable_cox_models_`outcome'_Sense5_time_ints`dataset'", text replace
...
if "`outcome'"=="covidadmission"  & "`dataset'"=="W2" {
* Open a log file
capture log close
log using "$logdir/07d_an_multivariable_cox_models_`outcome'_Sense5_time_ints`dataset'", text replace
...
if "`outcome'"=="covid_icu" & "`dataset'"=="MAIN" {
* Open a log file
capture log close
log using "$logdir/07d_an_multivariable_cox_models_`outcome'_Sense5_time_ints`dataset'", text replace
...
stcox 	i.kids_cat4 	 ///
			...
			60.timeperiod#1.reduced_kidney_function_cat						///
			90.timeperiod#1.reduced_kidney_function_cat					///		
			60.timeperiod#1.other_transplant						///
			90.timeperiod#1.other_transplant					///
			, strata(stp) vce(cluster household_id)
estimates
...
if "`outcome'"=="covid_death" & "`dataset'"=="MAIN" {
* Open a log file
capture log close
log using "$logdir/07d_an_multivariable_cox_models_`outcome'_Sense5_time_ints`dataset'", text replace
...
if "`outcome'"=="covid_death" & "`dataset'"=="W2" {
* Open a log file
capture log close
log using "$logdir/07d_an_multivariable_cox_models_`outcome'_Sense5_time_ints`dataset'", text replace
